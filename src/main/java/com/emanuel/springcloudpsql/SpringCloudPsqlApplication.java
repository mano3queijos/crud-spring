package com.emanuel.springcloudpsql;
...
public class SpringCloudPsqlApplication {

	public static void main(String[] args) {
		SpringApplication.run(SpringCloudPsqlApplication.class, args);
	}

//aqui eu não entendi mt bem
	@Bean
